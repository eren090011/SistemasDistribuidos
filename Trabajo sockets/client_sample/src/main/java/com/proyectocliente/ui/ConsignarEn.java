...
public class ConsignarEn extends javax.swing.JFrame {
    ...
    public ConsignarEn(String id,String operacion,String cantidad)
    {
        this.id = id;
    ...
    private void btnConsDebActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsDebActionPerformed
        ...
        String tarjeta = "debito";  
        String actualDeb=enviador1.consultarSaldo(this.id, tarjeta, "Consultar saldo");
        String nuevoDeb=enviador1.ConsignarDinero(id, this.cantidad, tarjeta, operacion);
        switch(nuevoDeb){
            case "supero el maximo de dinero permitido en una transaccion":
                ...
                this.setVisible(false);
                break;
            case "error al consignar dinero":
                // manda a una pantalla de error
            ...
            default:
                ...
                Recibo reciboDeb =new Recibo(this.id,this.operacion,tarjeta,actualDeb,nuevoDeb);
    ...
    private void btnConsCredActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsCredActionPerformed
        Enviador enviador1 = new Enviador();
        String tarjeta = "credito";
        String actualCred=enviador1.consultarSaldo(this.id, tarjeta, "Consultar saldo");
        String nuevoCred=enviador1.ConsignarDinero(id, this.cantidad, tarjeta, operacion);
        switch(nuevoCred){
            case "supero el maximo de dinero permitido en una transaccion":
                // manda a una pantalla de error
            ...
            default:
                // cuando todo salga bien, sacar recibo
                Recibo reciboCred =new Recibo(this.id,this.operacion,tarjeta,actualCred,nuevoCred);

...
public class Controlador{
    ...
    public List<Object[]> getAllNews(String ip,String port){
        Controlador c = new Controlador();
        List<Object[]> listaCombinada = new ArrayList<>();
        List<Object[]> listaPropia= c.listaNoticias();
        List<Object[]> listaOtro= crudNews.otrasNoticias(ip, port);
        listaCombinada.addAll(listaPropia);
        listaCombinada.addAll(listaOtro);
